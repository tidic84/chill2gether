...
export default function RoomPage() {
    ...
    useEffect(() => {
        const handleModeChanged = (data) => setRoomMode(data.mode);
        const handleRoleChanged = (data) => setDrawPermissions(data.drawPermissions || []);
        const handleScreenShareStart = () => setIsScreenSharing(true);
        const handleScreenShareStop = () => setIsScreenSharing(false);
    ...
    // Peut dessiner : admin ou permission explicite
