...
export default function HomePage() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center h-screen bg-gray-950 text-white">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div className="relative z-10 w-full max-w-2xl p-6">
                        ...
                        <Stepper
                            ...
                            onFinalStepCompleted={() => { console.log("All steps completed!"); setShowTutorial(false); }}
                        ...
                        >
                            ...
                            <Step>
                                ...
                                <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name?" className="w-full rounded border px-2 py-1" />
                            </Step>
                            <Step>
                                <h2>Final Step</h2>
                                <p>You made it!</p>
                ...
                <div
                    ...
                    >
                        <div className="p-4 text-left max-w-xs">
                            <h3 className="text-2xl font-extrabold text-white mb-2">Tutoriel</h3>
                            <p className="text-sm text-slate-200 mb-2">
                                Découvrez comment utiliser <br />
                                <span className="font-semibold text-white">Chill2Gether</span> 
                                en quelques <br />
            ...
            <div className="absolute flex bottom-0 right-0 z-20">
            </div>
        </div>
    );
}
