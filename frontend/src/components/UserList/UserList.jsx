                    ...
                    <>
                        {users.map((user, index) => (
                            <div key={user.userId} className="relative group">
                                <div className="flex flex-col items-center justify-center p-4 rounded-xl border border-zen-border dark:border-zen-dark-border bg-white dark:bg-zen-dark-surface hover:border-zen-clay dark:hover:border-zen-dark-clay/50 hover:shadow-md transition-all cursor-default group">
                                    {/* Avatar */}
