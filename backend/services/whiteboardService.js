 ...
 * }
 *
 * LIMITE : données non persistées en base de données.
 * Si le serveur redémarre, les tableaux blancs sont perdus.
 */
class WhiteboardService {
    ...
    /**
     * Merge les éléments entrants avec l'état courant (last-writer-wins par version).
     * @param {string} roomId
     * @param {Array} elements - Éléments Excalidraw reçus
     * @returns {Array} État complet mergé
     */
